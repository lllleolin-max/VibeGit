...
const actions: Record<keyof VibeGitApi, (args: unknown[]) => unknown | Promise<unknown>> = {
  ...
  renameCheckpoint: (args) => service.renameCheckpoint(argument<string>(args, 0), argument<string>(args, 1)),
  deleteCheckpoint: (args) => service.deleteCheckpoint(argument<string>(args, 0)),
  ...
  checkEnvironment: async () => {
    ...
    return {
      ...
      agents,
      changeSummarySkill: await service.changeSummarySkillStatus(agents),
